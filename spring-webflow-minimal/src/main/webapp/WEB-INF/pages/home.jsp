...
<html>
	...
	<div>
		<a href="account/login?accountType=auto">Login App-1 Account - Spring Webflow Request
	</div>
	
	<div>
		<a href="account/login?accountType=home">Login App-2 Account - Spring Webflow Request
	</div>
